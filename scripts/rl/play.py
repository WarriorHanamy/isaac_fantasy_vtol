...
# Allow Hydra overrides after AppLauncher parses CLI.
sys.argv = [sys.argv[0]] + hydra_args

# Enable USD cameras automatically if FPV camera is requested through Hydra.
if any(
    arg.startswith("env.enable_fpv_camera=") and arg.split("=", 1)[1].lower() in {"true", "1", "yes"}
